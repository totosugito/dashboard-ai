...
class SplitterLayout extends React.Component {
    ...
    render() {
        ...
        if (children.length === 0) {
            children.push(React.createElement('div', null));
        }
        ...
        for (let i = 0; i < children.length; ++i) {
            ...
            wrappedChildren.push(React.createElement(
                Pane,
        ...
        return React.createElement(
            'div',
            {
                className: containerClasses, ref: c => {
                    this.container = c;
                }
            },
            wrappedChildren[0],
            wrappedChildren.length > 1 && React.createElement('div', {
                role: 'separator',
